...
use App\Shared\Infrastructure\Converter\UlidTypeConverter;
...
final readonly class UlidTransformer
{
    ...
    public function toDatabaseValue(array|string|int|float|bool|object|null $value): ?Binary
    {
        ...
        $ulid = $this->typeConverter->toUlid($value);

        return new Binary($ulid->toBinary(), Binary::TYPE_GENERIC);
    }

    public function toPhpValue(array|string|int|float|bool|object|null $value): Ulid
    {
        $symfonyUlid = $this->typeConverter->fromBinary($value);
