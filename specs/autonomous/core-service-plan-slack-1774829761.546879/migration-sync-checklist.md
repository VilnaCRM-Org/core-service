...
| --- | --- | --- | --- | --- |
| `AGENTS.md` | Canonical routing docs | `yes` | `changed` | Added the core-service baseline and the explicit default-versus-advanced OpenAPI routing note so high-visibility guidance matches the planning decision. |
| `.claude/skills/AI-AGENT-GUIDE.md` | Canonical routing docs | `yes` | `changed` | Aligned the quick routing tree, skill catalog, and source-of-truth policy with the settled BMALPH and OpenAPI guidance. |
| `.claude/skills/SKILL-DECISION-GUIDE.md` | Canonical routing docs | `yes` | `changed` | Clarified the default OpenAPI path, the advanced OpenAPI path, and the repository portability guardrails in the decision surface. |
| `.claude/skills/README.md` | Canonical routing docs | `yes` | `changed` | Synced the contributor-facing skill catalog to the canonical routing policy and made the OpenAPI split explicit. |
