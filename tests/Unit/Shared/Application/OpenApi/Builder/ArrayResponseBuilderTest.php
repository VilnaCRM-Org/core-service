...
{
    private ArrayResponseBuilder $builder;
    private ArrayContextBuilder $contextBuilderMock;
    ...
    protected function setUp(): void
    {
        ...
        $this->contextBuilderMock =
            $this->createMock(ArrayContextBuilder::class);
        $this->builder = new ArrayResponseBuilder($this->contextBuilderMock);
