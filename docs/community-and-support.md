...
There are many ways to contribute to our project, from writing code and documentation to reporting bugs and suggesting enhancements. Please see our [Contributing Guide](https://github.com/VilnaCRM-Org/core-service/blob/main/CONTRIBUTING.md) for more details on how to get started.
...
If you encounter a security issue, please report it responsibly. Check our [Security Policy](https://github.com/VilnaCRM-Org/core-service/blob/main/SECURITY.md) for more details on how to report security vulnerabilities.
...
Learn more about [Legal and Licensing](legal-and-licensing.md).
