...
The `core-service` project is covered under the **Creative Commons CC0 1.0 Universal (CC0 1.0) Public Domain Dedication**. This means that all the work within the project is as far as possible in the public domain, or otherwise freely available for anyone to use for any purpose.
...
Learn more about the CC0 1.0 License [here](https://creativecommons.org/publicdomain/zero/1.0/legalcode).
