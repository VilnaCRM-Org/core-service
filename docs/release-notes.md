...
Check out [CHANGELOG.md](https://github.com/VilnaCRM-Org/core-service/blob/main/CHANGELOG.md) to see a detailed history of all changes, updates, and improvements made to the core service codebase.

## Milestones

Check out [Milestones](https://github.com/VilnaCRM-Org/core-service/milestones), to see the progress and upcoming goals for our project.
...
2. **Changelog Generation**: A new changelog entry is generated automatically from the commit messages via [this](https://github.com/VilnaCRM-Org/core-service/actions/workflows/autorelease.yml?query=branch%3Amain) GitHub action.
