...
Our Unit and Integration test coverage is **100%**. You can check [this](https://github.com/VilnaCRM-Org/core-service/actions) GitHub CI workflow to see the results of the latest Unit and Integration test execution.
...
We have **0** escaped and uncovered mutants in Core Service. You can check [this](https://github.com/VilnaCRM-Org/core-service/actions) GitHub CI workflow to see the results of the latest Mutation test execution.
...
Also, you can check [this](https://github.com/VilnaCRM-Org/core-service/actions) GitHub CI workflow to see the results of the latest Load test execution.
...
We cover each possible response with a separate test. You can check [this](https://github.com/VilnaCRM-Org/core-service/actions) GitHub CI workflow to see the results of the latest E2E test execution.
