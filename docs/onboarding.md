...
1. Navigate to the [VilnaCRM Core Service repository](https://github.com/VilnaCRM-Org/core-service).
...
- Please adhere to our **commit message conventions** specified [in our CONTRIBUTING.md file](https://github.com/VilnaCRM-Org/core-service/blob/main/CONTRIBUTING.md).
...
- Currently, we are using **MongoDB** for document-based storage.
