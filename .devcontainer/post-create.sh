...
# Let the Docker client negotiate the API version unless the operator set an override explicitly.
: "${DOCKER_API_VERSION:=}"
...
agent_env_file="${HOME}/.config/core-service/agent-secrets.env"
