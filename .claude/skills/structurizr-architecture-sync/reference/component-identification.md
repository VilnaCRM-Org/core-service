...
### Example 1: CreateCustomerCommandHandler
...
### Example 6: SendWelcomeEmailSubscriber
...
### Example 7: CustomerTest (PHPUnit test)
...
```dsl
customerValidator = component "CustomerValidator" "Validates customer data" ...
```
...
```dsl
group "Application" {
    createCustomerHandler = component "CreateCustomerHandler" ...
    updateCustomerHandler = component "UpdateCustomerHandler" ...
}
...
group "Application" {
    # Key entry points
    customerController = component "CustomerController" ...
    customerCommandHandler = component "CustomerCommandHandler" ...
}

group "Domain" {
    # Core domain model
    customer = component "Customer" "Customer aggregate" ...
    customerEmail = component "CustomerEmail" "Email value object with validation" ...
}

group "Infrastructure" {
    # Infrastructure adapters
    customerRepository = component "CustomerRepository" ...
    emailSubscriber = component "SendWelcomeEmailSubscriber" ...
}
```
