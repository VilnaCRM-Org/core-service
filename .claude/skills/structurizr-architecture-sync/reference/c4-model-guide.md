...
For this project, we focus on **Level 3: Component diagrams** within the Core Service container.

### Component Diagram Purpose

Show the internal structure of the Core Service:
...
✅ **Good**: `CustomerCommandHandler`, `CustomerRepository`, `Customer` entity

❌ **Too detailed**: `CustomerId` DTO, `CustomerMapper`, utility functions
