...
**Scenario**: Creating a new customer using CQRS with event-driven architecture
...
**Scenario**: Implementing GET /api/customers/{id} REST endpoint
...
**Scenario**: Refactoring monolithic CustomerCommandHandler into separate handlers
...
- Match class names: `CustomerCommandHandler` → `customerCommandHandler`
