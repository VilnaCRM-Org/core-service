...
group "Infrastructure" {
    orderRepository = component "OrderRepository" "MongoDB implementation of order persistence" "Repository" {
        tags "Item"
    }
...
If Order has related entities (e.g., Customer):

```dsl
# Customer relationship
order -> customer "belongs to"

# Or if Customer is managed separately
