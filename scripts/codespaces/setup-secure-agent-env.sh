...
write_codex_config() {
    ...
    openai_base_url_escaped="$(escape_toml_string "${CODEX_OPENAI_BASE_URL}")"
...
name = "OpenAI"
base_url = "${openai_base_url_escaped}"
...
Set CODEX_ALLOW_UNSAFE_MODE=1 to confirm full-access defaults, or override to safer settings.
EOM
        exit 1
    fi
}
